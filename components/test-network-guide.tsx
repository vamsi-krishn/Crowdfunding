        ...
        <AccordionItem value="what-is-test-eth">
          ...
          <AccordionContent>
            <p className="text-sm">
              ...
              applications on test networks like {DEFAULT_TEST_NETWORK.chainName}. You can get test ETH for free from
              faucets, which are websites that distribute small amounts of test ETH for development and testing
              purposes.
            </p>
          </AccordionContent>
        </AccordionItem>
